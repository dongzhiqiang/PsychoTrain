...
public class RoleStateFall : RoleState
{
    ...
    public TranPartCxt JumpCxt
    {
        get { return m_jumpCxt; }
        set
        {
            if (m_jumpCxt != null)
            {
    ...
    #region Frame
    public RoleStateFall(StatePart rsm, enRoleState enterType)
        : base(rsm, enterType)
    {
    ...
    public override void Enter(object param)
    {
        if (JumpCxt != null)
            JumpCxt = null;
        m_state = enFall.air;
        m_statePart.AniPart.Play("xialuo01", WrapMode.Loop, 0.2f, 1f, true);
