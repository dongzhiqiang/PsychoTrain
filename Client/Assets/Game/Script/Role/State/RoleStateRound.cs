...
public class RoleStateRound : RoleState
{
    ...
    #region Frame
    public RoleStateRound(StatePart rsm, enRoleState enterType)
    : base(rsm, enterType)
    {
    ...
    //如果没有碰撞不能移动
    public override bool CanEnter() { return !StatePart.IsNoCollider; }
    ...
    public override void Do(object param)
    {
        ...
        if (m_subState == enRoleRoundType.run)
        {
            ...
            m_statePart.AniPart.Play(AniFxMgr.Ani_PaoBu, WrapMode.Loop, 0.2f, m_cxt.speed / AniPart.MoveAniSpeed, true);
        }
        ...
        else if (m_subState == enRoleRoundType.stillLook)
        {
            ...
            m_statePart.AniPart.Play(AniFxMgr.Ani_DaiJi, WrapMode.Loop, 0.2f, 1, true);
        }
        else
