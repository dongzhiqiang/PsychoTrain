...
public class RoleSubGround : RoleBehitSubState
{
    ...
    public override bool CanParentLeave()
    {
        ...
        return (st == null || st.normalizedTime >= 1) && Parent.DeadPart.Check();
    }
    ...
    public override void Do()
    {
        ...
        float aniEndTime = TimeMgr.instance.logicTime + aniPart.CurSt.length;
    ...
    public override void Update()
    {
        ...
        if (TimeMgr.instance.logicTime >= m_groundEndTime)
        {
