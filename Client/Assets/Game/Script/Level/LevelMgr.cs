...
public class LevelMgr : Singleton<LevelMgr>
{
    ...
    public IEnumerator CreateHero(RoleCxt cxt, string camera = null)
    {
    ...
    //同一关卡切换场景时恢复角色
    public void ResetHero(RoleCxt cxt, string camera = null)
    {
        //之前没有销毁的角色要显示
    ...
    public Role CreateRole(RoleCxt cxt, string groupFlag = "", string pointFlag = "")
    {
